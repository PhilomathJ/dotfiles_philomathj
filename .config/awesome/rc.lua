...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, modalt    }, "l",     function () awful.tag.incmwfact( 0.05)          end,
              {description = "increase master width by 5%", group = "layout"}),
    awful.key({ modkey, modalt    }, "h",     function () awful.tag.incmwfact(-0.05)          end,
    ...
    awful.key({ modkey, modalt    }, "space", function () awful.layout.inc( 1)                end,
              {description = "select next layout", group = "layout"}),
    awful.key({ modkey, modalt, "Shift"   }, "space", function () awful.layout.inc(-1)                end,
        { description = "select previous layout", group = "layout" }),

    -- {{{ Custom Keybindings
    -- layout: Corner NW
    awful.key({ modkey, modalt   }, "n", function () awful.layout.set(awful.layout.suit.corner.nw) end,
        { description = "Corner - nw", group = "layout" }),
    -- layout: Spiral
    awful.key({ modkey, modalt   }, KEY.pgup, function () awful.layout.set(awful.layout.suit.spiral.dwindle) end,
        { description = "spiral - dwindle", group = "layout" }),
    -- layout: magnifier
    awful.key({ modkey, modalt   }, KEY.prtsc, function () awful.layout.set(awful.layout.suit.magnifier) end,
        { description = "magnifier", group = "layout" }),
    -- screen shot
...
awful.rules.rules = {
    ...
    -- Make Yakuake floating and top-center in order to allow the overlay to work
    { rule = { class = "yakuake" },
